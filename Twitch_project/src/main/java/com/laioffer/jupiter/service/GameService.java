...
public class GameService {
    private static final String TOKEN = "Bearer qanwjap0bdq235zzgbeeinrdnf0riy";
    private static final String CLIENT_ID = "53beazh4hwesiyy7noumf8qsw3ccye";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            ...
            try {
                // Encode special characters in URL, e.g. Jeremy Yu -> Jeremy%20Yu
